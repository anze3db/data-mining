...
force_mini = True
data_dir = data_dir = "data/" if ("xgrid" in gethostname() and not force_mini)  else "../"
orange_data_filename = data_dir + "trainingDataO2.pickled"
orange_test_filename = data_dir + "testDataO2.pickled"
orange_disc_filename = data_dir + "trainingDataOD2.pickled"
orange_disc_test_filename = data_dir + "testDataOD2.pickled"
